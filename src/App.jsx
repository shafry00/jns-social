...
{/* Navigation */}
      ...
      {/* Donation Ticker Banner - Fixed, in front of navbar */}
      <div className="fixed left-0 right-0 z-[60] bg-primary-green/95 backdrop-blur-sm py-2 overflow-hidden" style={{ top: '72px' }}>
